# tf-azurerm-module_reference-resource_group
...
This module is used to deploy a single resource group with a launch recommended naming convention.
...
| <a name="input_tags"></a> [tags](#input\_tags) | variables required by resource groups module | `map(string)` | `{}` | no |
